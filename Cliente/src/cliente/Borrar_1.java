 ...
 * @author kejor
 */
public class Borrar_1 extends javax.swing.JFrame {
    String Nombre ;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Borrar_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
